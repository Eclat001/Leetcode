 ...
 * have the same color. The cost of painting each house with a certain color is represented by a n x k cost 
 * matrix. For example, costs[0][0] is the cost of painting house 0 with color 0; costs[1][2] is the cost of 
